<?php
		...
		if ($pic != null) {
			echo '<div class ="staffpic" style = "width: 100px; height: 100px; margin: 0 auto;">
				...
				<center>
				<br/>
				<a href="javascript:void(0)" onclick="delete_pic('.$staffid.')" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Delete Photo"><i class="ace-icon fa fa-times"></i> Delete Photo</a>
				</center>
				';
		} 
	
		else { ?>
				<form action="functions/fetchstaff.php" method="POST" enctype="multipart/form-data">
