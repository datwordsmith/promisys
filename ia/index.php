     ...
     <div class="row">
				...
				<div class="col-md-12 col-xs-12">	
 					<div style="margin-bottom: 10px;">
						<a href="index?changepassword=<?php echo $loginid; ?>" data-toggle="modal" data-target="#changeBox" class="btn btn-success btn-sm pull-right" ><i class="ace-icon fa fa-lock"></i> Change Password</a>
					</div>
							...
							<div class="box  box-warning">
								<div class="box-header with-border">
								  ...
								  <div class="box-tools pull-right">
									<a href="index?editprofile=<?php echo $loginid; ?>" data-toggle="modal" data-target="#editBox" class="btn btn-warning btn-sm btn-info" ><i class="ace-icon fa fa-pencil-square-o"></i> Edit My Profile</a>
								  </div>
								</div>				  
								<!-- /.box-header -->
								...
								<div class="box-body"  style="overflow-x:auto;">
													...
													<table class="table no-border table-responsive" >
															...
															<tr><th width=30%>Department</th> <td><?php echo $dept; ?></td> </tr>
													</table>
								</div>
								<!-- /.box-body -->
							</div>	
