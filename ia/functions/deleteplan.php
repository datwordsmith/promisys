...
//Include database configuration file
	...
	if (isset($_POST['planid'])) {
		...
		$getPpId = mysqli_fetch_object(mysqli_query($conn,  "SELECT * FROM prospectplan where id = '$planid'"));
		$ppId = $getPpId->prospectproperty_id;

		$delete = mysqli_query($conn, "DELETE FROM prospectplan WHERE id = $planid");
...
?>
				...
				<div class="" style="margin-top: 20px; margin-bottom: 20px;">
						<?php
							...
							$checkletter = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM prospect_property where id = '$ppId' and rfo = 1"));
