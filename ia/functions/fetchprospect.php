...
if(isset($_POST['addprospect'])) {
		...
		if (mysqli_num_rows($check) < 1) {
				...
				$add = "INSERT INTO prospects (email, title, lastname, firstname, middlename, sex, dob, phone, mobile, occupation, address, staffid) VALUES ('$email', '$title', '$lastname', '$firstname', '$middlename', '$sex', '$newdob', '$phone', '$mobile', '$occupation', '$address', '$loginid')";
