				  ...
				  <div class="box  box-warning">
					...
					<div class="box-body"  style="overflow-x:auto;">
							...
							<?php									
									...
									$counter = 1;
									$all = mysqli_query($conn, "SELECT * from client where MONTH(dob) = $monthid and id in (SELECT client_id from client_property where staff_id = '$loginid') order by dob desc");
