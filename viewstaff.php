													...
													<table class="table no-border table-responsive" >
															...
															if ($status == 0) {
																...
																if ($loginid == $staffid) {
																	...
																	echo '<tr class="danger"><th width=30%>Status</th> <td colspan=2>'.$stat.' <a href="javascript:void(0)" onclick="change_status('.$staffid.')" class="btn btn-xs btn-success pull-right"><i class="ace-icon fa fa-check-circle-o"></i> <span class="hidden-xs">Activate</span></a></td> </tr>';
																}
																...
																if ($loginid == $staffid) {
																	...
																	echo '<tr class="success"><th width=30%>Status</th> <td colspan=2>'. $stat.'<a href="javascript:void(0)" onclick="change_status('.$staffid.')" class="btn btn-xs btn-danger pull-right"><i class="ace-icon fa fa-times"></i> <span class="hidden-xs">Deactivate</span></a></td> </tr>';
																}															
															}
