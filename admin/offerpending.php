...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Pending Requests
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="administrator"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"> Offer Letters - Pending Requests</li>
      </ol>
    </section>
					...
					<div class="col-md-12 col-xs-12">
						  ...
						  <div class="box  box-info">
							...
							<table id="myTable" class="table table-striped"  style="padding-bottom: 50px">
									...
									<thead><th>Date</th> <th>Prospect</th> <th>Project</th> <th>Property</th> <th>Units</th> <th>Amount</th> <th><span class="pull-right">Tax</span></th> <th><center>Advised by</center></th> <th><center>Action</center></th></tr> </thead>

									<tbody>
										<?php

										//$counter = 1;
										$all = mysqli_query($conn,  "SELECT * FROM prospect_property where rfo = 1 order by date asc");
