	 	...
	 	<div class="col-md-12" style="padding: 20px;">
	 		...
	 		<?php 
		 		if($rfo == 2){
		 			echo '
				  	<div>
				  		<p class="text-success" style="font-size: 1.2em; ">You have invited the Investment Advisor to pick up the Offer Letter.</p>
				  	</div>';
		 		} else {
					echo '
					<div class="checkbox">
					    <label>
					      <input type="checkbox" class="invite" style="font-size: 4.5em"> Invite Investment Advisor to pick up Offer Letter. 
					    </label>
					</div>

				  	<div>
				  		<button type="button" class="btn btn-success invitebtn" data-id="'.$prospectPropertyId.'" style="display: none;">Submit</button>
				  	</div>';
		 		}
	 		?>
