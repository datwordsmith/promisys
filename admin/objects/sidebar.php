<section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php echo $offerletters;?>">
          <a href="">
            <i class="fa fa-file-text"></i>
            <span>Request for Offer Letter</span>
            <span class="pull-right-container">
              <span class="label label-warning"><?php pendingRequests(); ?></span>
            </span> 
          </a>
            <ul class="treeview-menu">
              <li class="<?php echo $offerpending;?>">
                <a href="offerpending"><i class="fa fa-circle-o"></i>
                  <span>Pending Requests</span>
                  <span class="pull-right-container">
                    <span class="label label-primary"><?php pendingRequests(); ?></span>
                  </span>                  
                </a>
              </li>

              <li class="<?php echo $offersent;?>">
                <a href="offersent"><i class="fa fa-circle-o"></i>
            ...
            <ul class="treeview-menu">
              <li class="<?php echo $clientbirthdays;?>">
                <a href="clientBirthdays"><i class="fa fa-circle-o"></i>
                  <span>Client/Prospect Birthdays</span>
                  <span class="pull-right-container">
