				  ...
				  <div class="box  box-warning">
					...
					<div class="box-body"  style="overflow-x:auto;">
							<table id="myTable" class="table table-striped table-bordered table-hover table-responsive" >
										<thead><tr><th></th> <th></th> <th>Staff Name</th> <th class="hidden-xs">Email</th> <th>Sex</th> <th class="hidden-xs">Birthdate</th> <th>Role</th> <!--<th><i class="fa fa-bell" aria-hidden="true"></i></th>--> </tr> </thead>  
												...
												<tr>
														...
														<td>
															...
															<ul class="dropdown-menu" role="menu">
																<li><a href="viewstaff?details='.$staff->id.'">View</a></li>
																<li><a href="#changeBox" data-toggle="modal" data-target="#changeBox" data-id="'.$staff->id.'" class="changerole" >Change Role</a></li>';
																
																$status = $staff->status;
																if ($status == 0) {
																	echo '<li><a href="staff?activate='.$staff->id.'">Activate</a></li>';
																} else {
																	echo '<li><a href="staff?deactivate='.$staff->id.'">Deactivate</a></li>';
																}
															echo '
															</ul>
															</div>														
