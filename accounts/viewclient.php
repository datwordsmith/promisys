						  ...
						  <div class="box  box-info">
							...
							<div class="box-body"  style="overflow-x:auto;">
								...
								<form  method="POST" action="functions/fetchviewclient.php" id="assign_form">
									...
									<input type="number" class="form-control" min="1000000" onchange="select_cost()" placeholder="Amount" name = "amount" id = "amount" required disabled>		
										<div style="clear:both;">&nbsp;</div>
									</div>

									<div class="col-md-2 col-xs-12">									
										<input type="number" class="form-control" min="1" onchange="choose_unit()" placeholder="Qty" name = "quantity" id = "quantity" required disabled>		
										<div style="clear:both;">&nbsp;</div>											
									</div>		

									<div class="col-md-4 col-xs-12">									
										<select name="staff" id="staff" class="form-control" onchange="change_staff()" required disabled>
														...
														<td>														
															...
															<ul class="dropdown-menu" role="menu">
																...
																if (mysqli_num_rows($delbutton) > 0) {
																	echo '<li><a href="#viewBox" data-toggle="modal" data-target="#viewBox" data-id="'.$accountid.'" class="paymentdetail"> <i class="ace-icon fa fa-history"></i> Payment History</a></li>';
																	if ($fileid <> NULL) {
...
/*function generate_id(clientPropertyId) {
	...
	*/
	...
	/* function printFunction() 
	{
		var divToPrint=document.getElementById('paymentHistory');
	...
	function change_project() {		
		...
		var xmlhttp = new XMLHttpRequest ();
		var theVal =  document.getElementById('project').value;
