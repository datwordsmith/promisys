    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        --> 
        <li class="<?php echo $initialinvestment;?>">
          <a href="initialinvestment">
            <i class="fa fa-circle-o"></i>
            <span>Initial Investments</span>
            <span class="pull-right-container">
              <span class="label label-primary"><?php pendingConfirmation(); ?></span>
            </span>                  
          </a>
        </li>        
        ...
        <li class="treeview <?php echo $birthdays;?>">
          <a href="">
            ...
            <span>Birthdays</span>
            <span class="pull-right-container">
              <span class="label label-warning"><?php staffBirthdays(); ?></span>
            </span>
          </a>
