<?php
	...
	if(isset($_GET['details'])) {
		$departmentid = $_GET['details'];
	
		if (is_numeric($departmentid)) {
			$getconfam = mysqli_fetch_object(mysqli_query($conn, "SELECT * FROM departments where id = $departmentid"));
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-briefcase"></i> <?php echo " Department: ".$department->department; ?>
        <small></small>
      </h1>
      <ol class="breadcrumb">
