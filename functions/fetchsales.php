...
if(isset($_GET['addpayment'])) {	
		...
		$_SESSION["clientpropertyid"] = $clientPropertyId; 
			...
			$investmentcategory_id = $detail->investmentcategory_id;
...
<div class="modal-body">
			...
			<table id="myTable" class="table " >
					...
					<tr><th width=30%>Property Type</th> <td><?php echo $property->property_type. '<span class="productcategory"> <b>('.$category.')</b></span>'; ?></td> </tr>
