				  ...
				  <div class="box  box-warning">
					...
					<div class="box-body"  style="overflow-x:auto;">
							<table id="myTable" class="table table-striped table-bordered table-hover table-responsive" >
										<thead><tr><th></th> <th></th> <th>Staff Name</th> <th class="hidden-xs">Email</th> <th>Sex</th> <th class="hidden-xs">Birthdate</th> <th>Department</th> <!--<th><i class="fa fa-bell" aria-hidden="true"></i></th>--> </tr> </thead>  
